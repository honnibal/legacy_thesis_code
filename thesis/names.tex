...
\newcommand{\abcg}{\textsc{ab} \textsc{cg}\xspace}
...
\newcommand{\kpml}{\textsc{kpml}\xspace}
\newcommand{\hlds}{\textsc{hlds}\xspace}
...
\newcommand{\psunary}[2]{\ensuremath{\langle #1\;\longrightarrow\;#2\rangle\;}}
...
\newtheorem*{headcat}{Head Categorial Uniqueness}
\newtheorem*{combinatorytransparency}{The Principle of Combinatory Type Transparency}
\newtheorem*{hatpreservation}{Principle of Hat Preservation}
\newtheorem*{nullhatstip}{Null Hat Stipulation}
\newtheorem*{nullmodestip}{Null Mode Stipulation}
\newtheorem*{slashindexstip}{Slash Index Stipulation}
...
\newcommand{\slashsc}{\textsc{slash}\xspace}
\newcommand{\headsc}{\textsc{head}\xspace}
\newcommand{\semsc}{\textsc{sem}\xspace}
\newcommand{\hatsc}{\textsc{hat}\xspace}
...
\newcommand{\cH}{\textbf{\textsf{H}}\xspace}
